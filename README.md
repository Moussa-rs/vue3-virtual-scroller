...
```
npm install --save vue3-virtual-scroller@next
```

```
yarn add vue3-virtual-scroller@next
```
...
```js
import 'vue3-virtual-scroller/dist/style.css'
```

## Browser

```html
<link rel="stylesheet" href="vue3-virtual-scroller/dist/style.css"/>
...
There are several components provided by `vue3-virtual-scroller`:
